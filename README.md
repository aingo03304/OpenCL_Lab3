...
# Lab assignment 3 - OpenCL 1D Convolution 
...
The following will compile the template file that you will modify to implement 1D convolution in OpenCL, and the data generator that will generate input files. 
...
This will create an directory that contains multiple pairs of input data. You can modify the file to generate input data of different sizes.
